...
namespace Eon {
	...
	/// <summary>
	/// Определяет компонент <seealso cref="IXInstance"/>, принадлежащий Oxy-приложению <seealso cref="IXApp{TDescription}"/>.
	/// </summary>
	public interface IXAppScopeInstance
		:IXInstance {

		/// <summary>
		/// Возвращает Oxy-приложение, которому принадлежит данный компонент.
