...
namespace Eon {
	...
	/// <summary>
	/// Представляет список инициализации Oxy-приложения (см. <seealso cref="IXApp{TDescription}"/>) — список компонентов, которые должны быть созданы и инициализированы при инициализации приложения.
	/// </summary>
