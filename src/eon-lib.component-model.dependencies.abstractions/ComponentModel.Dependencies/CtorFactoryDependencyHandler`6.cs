...
namespace Eon.ComponentModel.Dependencies {
	...
	public class CtorFactoryDependencyHandler<TArg1, TArg2, TArg3, TArg4, TArg5, TDependencyInstance>
		:FactoryDependencyHandlerBase<TDependencyInstance>
		where TDependencyInstance : class {

		const int __ArgsCount = 5;

		#region Static members

		static readonly DisposableLazy<Func<TArg1, TArg2, TArg3, TArg4, TArg5, TDependencyInstance>> __DependencyInstanceCtor;

		static CtorFactoryDependencyHandler() {
			__DependencyInstanceCtor =
				new DisposableLazy<Func<TArg1, TArg2, TArg3, TArg4, TArg5, TDependencyInstance>>(() => ActivationUtilities.RequireConstructor<TArg1, TArg2, TArg3, TArg4, TArg5, TDependencyInstance>());
		}

		#endregion

		Func<Func<TArg1, TArg2, TArg3, TArg4, TArg5, TDependencyInstance>> _getDependencyCtor;

		Func<TArg1, TArg2, TArg3, TArg4, TArg5, TDependencyInstance> _customCtor;

		readonly bool _canShareDependency;

		IArgsTuple<TArg1, TArg2, TArg3, TArg4, TArg5> _factoryArgs;
		...
		public CtorFactoryDependencyHandler(
			...
			IArgsTuple<TArg1, TArg2, TArg3, TArg4, TArg5> factoryArgs = null)
			: this(
				 customCtor: null,
		...
		public CtorFactoryDependencyHandler(
			Func<TArg1, TArg2, TArg3, TArg4, TArg5, TDependencyInstance> customCtor = null,
