...
namespace System.Text {
	...
	public static partial class EonStringBuilderUtilities {
		...
		static EonStringBuilderUtilities() {
		...
		static void P_ReleaseBuffer(AcquiredStringBuilderCookie cookie) {
			var sb = cookie.StringBuilder.PropArg($"{nameof(cookie)}.{nameof(cookie.StringBuilder)}").EnsureNotNull().Value;
			//
			sb.Clear();
			var updateResult =
				itrlck
